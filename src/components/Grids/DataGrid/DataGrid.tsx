                    ...
                    <tbody>
                        {vm.isLoading ? (
                            ...
                            vm.rows.map((row, rowIndex) => (
                                <tr
                                    key={(row as Record<string, unknown>)[gridOptions.model.primaryKey] as string ?? rowIndex}
...
export const DataGrid = memo(forwardRef(DataGridInner)) as <T extends { id?: string | number }>(
