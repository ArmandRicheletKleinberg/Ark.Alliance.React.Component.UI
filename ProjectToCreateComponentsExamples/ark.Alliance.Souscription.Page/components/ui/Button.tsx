...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  const variants = {
    primary: "bg-primary hover:opacity-90 text-white shadow-[0_0_15px_rgba(99,102,241,0.5)] focus:ring-primary",
    secondary: "bg-secondary hover:opacity-90 text-white shadow-[0_0_15px_rgba(168,85,247,0.5)] focus:ring-secondary",
